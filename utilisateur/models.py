...
class Patient(models.Model):
    ...
    mutuelle = models.ForeignKey('dpi.Mutuelle',on_delete=models.CASCADE,null=True)
    contact_urgence = models.ForeignKey('dpi.ContactUrgence',on_delete=models.CASCADE,null=True)
    def __str__(self):
